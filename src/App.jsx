  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="bg-green-700 text-white p-4 text-center shadow-md">
        <h1 className="text-3xl font-bold">🏠 NyumbaLink</h1>
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        {page === 'home' && (
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Welcome to NyumbaLink</h2>
        ...
        {page === 'list' && (
          <div className="py-4">
            ...
            <div className="bg-white rounded-xl shadow-md p-5">
              ...
              <textarea className="w-full border border-gray-300 rounded-lg px-4 py-3 mb-4 focus:outline-none focus:ring-2 focus:ring-green-400 h-24" placeholder="Description of the house..." value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} />
              <button onClick={handleSubmit} disabled={submitting} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold">
